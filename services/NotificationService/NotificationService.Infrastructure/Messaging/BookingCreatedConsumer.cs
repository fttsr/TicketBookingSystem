...
namespace NotificationService.Infrastructure.Messaging
{
    public class BookingCreatedConsumer : BackgroundService
    {
        ...
        public BookingCreatedConsumer(IConfiguration configuration, IServiceScopeFactory scopeFactory)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.ReceivedAsync += async (_, args) =>
            {
                try
                {
                    ...
                    await notificationService.SendBookingCreatedAsync(new Application.DTOs.BookingCreatedNotificationDto
                    {
                        Email = message.Email,
